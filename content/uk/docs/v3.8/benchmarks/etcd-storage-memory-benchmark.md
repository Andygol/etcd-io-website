...
Індекс в памʼяті містить усі ключі в структурі даних [B-tree][btree], разом з вказівниками на дані на диску (значення). Кожен ключ у B-tree може містити кілька вказівників, що вказують на різні версії його значень. Теоретичне споживання памʼяті індексом в памʼяті можна приблизно оцінити за формулою:

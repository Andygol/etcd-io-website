...
* [Огляд моделі даних etcd](/docs/v3.8/learning/data_model/)
...
## WAL: Журнал попереднього запису {#wal-write-ahead-log}

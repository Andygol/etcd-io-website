...
*Sub Connection*: Інтерфейс gRPC SubConn. Кожне суб-зʼєднання містить список адрес. Балансувальник створює SubConn зі списку розвʼязаних адрес. gRPC ClientConn може відповідати кільком SubConn (наприклад, example.com перетворюється на `10.10.10.1` та `10.10.10.2` двох суб-зʼєднань). Балансувальник etcd v3.4 використовує внутрішній розвʼязувач для встановлення одного суб-зʼєднання для кожної точки доступу.
...
*Правильність*. Запити можуть завершуватися з помилкою у разі виникнення збоїв на сервері. Однак це ніколи не порушує гарантій узгодженості: властивостей глобального впорядкування, заборони запису пошкоджених даних, семантики «не більше одного разу» для операцій, що змінюють дані, того, що спостережувач ніколи не фіксує часткових подій тощо.
...
### clientv3-grpc1.0: Огляд балансувальника {#clientv3-grpc10-balancer-overview}
...
![client-balancer-figure-01.png](/docs/v3.8/learning/img/client-balancer-figure-01.png)

### clientv3-grpc1.0: Обмеження балансувальника {#clientv3-grpc10-balancer-limitation}
...
### clientv3-grpc1.7: Огляд балансувальника {#clientv3-grpc17-balancer-overview}
...
![client-balancer-figure-02.png](/docs/v3.8/learning/img/client-balancer-figure-02.png)

![client-balancer-figure-03.png](/docs/v3.8/learning/img/client-balancer-figure-03.png)
...
![client-balancer-figure-04.png](/docs/v3.8/learning/img/client-balancer-figure-04.png)

![client-balancer-figure-05.png](/docs/v3.8/learning/img/client-balancer-figure-05.png)
...
![client-balancer-figure-06.png](/docs/v3.8/learning/img/client-balancer-figure-06.png)

### clientv3-grpc1.7: Обмеження балансувальника {#clientv3-grpc17-balancer-limitation}
...
![client-balancer-figure-07.png](/docs/v3.8/learning/img/client-balancer-figure-07.png)
...
![client-balancer-figure-08.png](/docs/v3.8/learning/img/client-balancer-figure-08.png)
...
### clientv3-grpc1.23: Огляд балансувальника {#clientv3-grpc123-balancer-overview}

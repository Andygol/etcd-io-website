...
Щоб оновити наявне розгортання etcd до 3.5, кластер, що працює, повинен бути версії 3.4 або вище. Якщо це версія до 3.4, будь ласка, [оновіть до 3.4](/docs/v3.8/upgrades/upgrade_3_3/) перед оновленням до 3.5.
...
[Завантажте резервну копію знімка](/docs/v3.8/op-guide/maintenance/#snapshot-backup), щоб забезпечити шлях до пониження версії у разі виникнення проблем.

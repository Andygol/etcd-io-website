...
З версії v3.4 додано дві нові точки доступу `/livez` та `/readyz`.
...
Існує набір [стандартних сповіщень](https://github.com/etcd-io/etcd/tree/main/contrib/mixin) для кластерів etcd v3 для Prometheus.
...
![](/docs/v3.8/op-guide/etcd-sample-grafana.png)
...
[template]: /docs/v3.8/op-guide/grafana.json

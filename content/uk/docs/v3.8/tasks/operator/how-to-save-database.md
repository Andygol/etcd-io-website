...
* [Встановити etcdctl, etcdutl](/docs/v3.8/install/)
* [Налаштувати локальний кластер](/docs/v3.8/dev-guide/local_cluster/)
...
```bash
-w, --write-out string   встановити формат виводу (fields, json, protobuf, simple, table) (типово "simple")
```

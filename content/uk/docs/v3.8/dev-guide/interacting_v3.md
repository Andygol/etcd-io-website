...
Ось команда для діапазону всіх ключів з префіксом `foo` за допомогою RPC [`RangeStream`](/docs/v3.8/learning/api/#rangestream). Результат ідентичний унарному `Range`:

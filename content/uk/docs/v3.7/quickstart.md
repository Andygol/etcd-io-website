...
Дотримуйтесь цих інструкцій, щоб локально встановити, запустити і протестувати кластер, що складається з одного члена etcd:
 ...
 2. Запустіть `etcd`:
    ...
    **Примітка**: Вивід, який створює `etcd` є [журналами](/docs/v3.7/op-guide/configuration/#logging)&nbsp;&mdash; логи інформаційного рівня можна ігнорувати.

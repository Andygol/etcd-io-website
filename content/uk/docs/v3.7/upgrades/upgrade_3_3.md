...
Щоб оновити наявне розгортання etcd до 3.3, кластер, що працює, повинен бути версії 3.2 або вище. Якщо версія нижче 3.2, будь ласка, [оновіть до 3.2](/docs/v3.7/upgrades/upgrade_3_2/) перед оновленням до 3.3.
...
Будь ласка, [зробіть резервну копію теки даних](/docs/v3.7/op-guide/maintenance/#snapshot-backup) всіх членів etcd, щоб зробити можливим пониження версії кластера навіть після його повного оновлення.
...
На цьому етапі добре [зробити резервну копію даних etcd](/docs/v3.7/op-guide/maintenance/#snapshot-backup), щоб забезпечити шлях до пониження версії у разі виникнення будь-яких проблем:

...
- Змінено змінні середовища etcdctl. Якщо `ETCDCTL_API=2 etcdctl cluster-health` працює належним чином, але `ETCDCTL_API=3 etcdctl endpoints health` відповідає `Error:  grpc: timed out when dialing`, обовʼязково використовуйте [нові імена змінних](https://github.com/etcd-io/etcd/tree/main/etcdctl#etcdctl).

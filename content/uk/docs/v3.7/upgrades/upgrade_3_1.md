...
Щоб оновити поточне розгортання etcd до 3.1, кластер, що працює, повинен бути версії 3.0 або вище. Якщо це версія до 3.0, будь ласка, [оновіть до 3.0](/docs/v3.7/upgrades/upgrade_3_0/) перед оновленням до 3.1.
...
#### 3. Встановіть двійковий файл etcd v3.1 і запустіть новий процес etcd {#3-drop-in-etcd-v31-binary-and-start-the-new-etcd-process}
...
#### 4. Повторіть кроки 2 та 3 для всіх інших членів {#4-repeat-step-2-to-step-3-for-all-other-members}

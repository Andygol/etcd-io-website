...
Щоб оновити поточне розгортання etcd до 3.4, кластер, що працює, повинен бути 3.3 або вище. Якщо це до 3.3, будь ласка, [оновіться до 3.3](/docs/v3.7/upgrades/upgrade_3_3/) перед оновленням до 3.4.
...
Будь ласка, [завантажте резервну копію знімка](/docs/v3.7/op-guide/maintenance/#snapshot-backup), щоб зробити можливим пониження версії кластера навіть після його повного оновлення.
...
[Завантажте резервну копію знімка](/docs/v3.7/op-guide/maintenance/#snapshot-backup), щоб забезпечити шлях до пониження версії у разі виникнення будь-яких проблем.

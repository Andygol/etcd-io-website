...
### У чому різниця між listen-<client,peer>-urls, advertise-client-urls або initial-advertise-peer-urls? {#what-is-the-difference-between-listen-clientpeer-urls-advertise-client-urls-or-initial-advertise-peer-urls}
...
### Чому зміна `--listen-peer-urls` або `--initial-advertise-peer-urls` не оновлює рекламовані peer URLs у `etcdctl member list`? {#why-doesnt-changing---listen-peer-urls-or---initial-advertise-peer-urls-update-the-advertised-peer-urls-in-etcdctl-member-list}
...
### Що таке відмовостійкість? {#what-is-failure-tolerance}
...
[api-mvcc]: /docs/v3.7/learning/api/#revisions
[backend_commit_metrics]: /docs/v3.7/metrics/#disk
[backup]: /docs/v3.7/op-guide/recovery/#snapshotting-the-keyspace
[benchmark]: https://github.com/etcd-io/etcd/tree/main/tools/benchmark
[benchmark-result]: /docs/v3.7/op-guide/performance/
...
[hardware-setup]: /docs/v3.7/op-guide/hardware/
[maintenance-compact]: /docs/v3.7/op-guide/maintenance/#history-compaction-v3-api-key-value-database
[maintenance-defragment]: /docs/v3.7/op-guide/maintenance/#defragmentation
...
[runtime reconfiguration]: /docs/v3.7/op-guide/runtime-configuration/
[supported-platform]: /docs/v3.7/op-guide/supported-platform/
[tuning]: /docs/v3.7/tuning/
[wal_fsync_duration_seconds]: /docs/v3.7/metrics/#disk

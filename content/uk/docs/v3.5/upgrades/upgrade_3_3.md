...
Будь ласка, [зробіть резервну копію теки даних](/docs/v3.5/op-guide/maintenance/#snapshot-backup) всіх членів etcd, щоб зробити можливим пониження версії кластера навіть після його повного оновлення.
...
На цьому етапі добре [зробити резервну копію даних etcd](/docs/v3.5/op-guide/maintenance/#snapshot-backup), щоб забезпечити шлях до пониження версії у разі виникнення будь-яких проблем:

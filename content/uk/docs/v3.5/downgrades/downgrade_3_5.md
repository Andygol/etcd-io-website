...
Якщо будь-який член був знижений до 3.4, версія кластера буде знижена до 3.4, і операції будуть сумісні з "3.4". Вам потрібно буде дотримуватися інструкцій [Оновлення etcd з 3.4 до 3.5](/docs/v3.5/upgrades/upgrade_3_5/), щоб відкотитися.

Будь ласка, [завантажте резервну копію знімка](/docs/v3.5/op-guide/maintenance/#snapshot-backup), щоб зробити можливим зниження версії кластера навіть після його повного зниження.
...
[Завантажте резервну копію знімка](/docs/v3.5/op-guide/maintenance/#snapshot-backup), щоб забезпечити шлях для зниження версії у разі виникнення проблем.

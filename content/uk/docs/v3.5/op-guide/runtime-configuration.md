...
Якщо певного члена втрачено, це еквівалентно заміні зламаної машини. Кроки описані в розділі [Заміна зламаної машини](/docs/v3.5/op-guide/runtime-configuration/#replace-a-failed-machine).
...
[conf-adv-peer]: /docs/v3.5/op-guide/configuration/#clustering
[conf-name]: /docs/v3.5/op-guide/configuration/#member
[design-learner]: /docs/v3.5/learning/design-learner/
[disaster recovery]: /docs/v3.5/op-guide/recovery/
...
[member-api-grpc]: /docs/v3.5/dev-guide/api_reference_v3/
[remove member]: #remove-a-member
[runtime-reconf]: /docs/v3.5/op-guide/runtime-reconf-design/

...
`advertise-client-urls` і `initial-advertise-peer-urls` вказують адреси, які клієнти etcd або інші члени etcd повинні використовувати для звʼязку з сервером etcd. Оголошені адреси повинні бути доступні з віддалених машин. Не оголошуйте адреси, такі як `localhost` або `0.0.0.0`, для промислового налаштування, оскільки ці адреси недоступні з віддалених машин.

### Чому зміна `--listen-peer-urls` або `--initial-advertise-peer-urls` не оновлює оголошені peer URLs у `etcdctl member list`? {#why-doesеt-changing---listen-peer-urls-or---initial-advertise-peer-urls-update-the-advertised-peer-urls-in-etcdctl-member-list}
...
[api-mvcc]: /docs/v3.5/learning/api/#revisions
[backend_commit_metrics]: /docs/v3.5/metrics/#disk
[backup]: /docs/v3.5/op-guide/recovery/#snapshotting-the-keyspace
[benchmark]: https://github.com/etcd-io/etcd/tree/master/tools/benchmark
[benchmark-result]: /docs/v3.5/op-guide/performance/
...
[hardware-setup]: /docs/v3.5/op-guide/hardware/
[maintenance-compact]: /docs/v3.5/op-guide/maintenance/#history-compaction-v3-api-key-value-database
[maintenance-defragment]: /docs/v3.5/op-guide/maintenance/#defragmentation
...
[runtime reconfiguration]: /docs/v3.5/op-guide/runtime-configuration/
[supported-platform]: /docs/v3.5/op-guide/supported-platform/
[tuning]: /docs/v3.5/tuning/
[wal_fsync_duration_seconds]: /docs/v3.5/metrics/#disk

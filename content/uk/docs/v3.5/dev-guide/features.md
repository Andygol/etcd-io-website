...
- Експериментальна [функціональна можливість прибирається](#feature-deprecation), коли вона переходить до стабільної стадії. Користувачі повинні почати використовувати стабільну функціональну можливість якомога швидше.
...
- Документація експериментальної функції буде містити повідомлення про застарівання з рекомендацією використовувати повʼязану стабільну функціональну можливість, наприклад, `DEPRECATED. Use <feature-name> instead.`

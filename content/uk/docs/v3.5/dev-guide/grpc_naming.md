...
weight: 3500
description: "go-grpc: для вирішення gRPC точок доступу з бекендом etcd"
---
...
Зверніть увагу, що ця функція є експериментальною, оскільки вона залежить від пакунку [google.golang.org/grpc/resolver][], який досі є експериментальним у grpc-go.

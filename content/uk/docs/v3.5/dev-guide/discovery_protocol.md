...
Зазвичай розмір кластера становить 3, 5 або 7 учасників. Перевірте розділ [Оптимальний розмір кластера][cluster-size] для отримання додаткової інформації.
...
Процес очікування детально описаний у [документації API etcd][api].

...
- [AdoHe/etcd4j](https://github.com/AdoHe/etcd4j) - Підтримує v2 (покращено для реального промислового кластера)
...
- [etcd-cpp-apiv3/etcd-cpp-apiv3](https://github.com/etcd-cpp-apiv3/etcd-cpp-apiv3) - Підтримує v3

...
## Порівняльна таблиця {#comparison-chart}
...
| Мінімальна затримка лініаризації читання | RTT мережі | Немає лініаризації читання | RTT + fsync | Барʼєри годинника (атомні, NTP) |
...
[etcd-commonname]: /docs/v3.5/op-guide/authentication/#using-tls-common-name
...
[etcd-json]: /docs/v3.5/dev-guide/api_grpc_gateway/
[etcd-linread]: /docs/v3.5/learning/api_guarantees/#linearizability
[etcd-mvcc]: /docs/v3.5/learning/data_model/
[etcd-rbac]: /docs/v3.5/op-guide/authentication/rbac/
[etcd-recipe]: https://godoc.org/github.com/etcd-io/etcd/client/v3/experimental/recipes
[etcd-reconfig]: /docs/v3.5/op-guide/runtime-configuration/
[etcd-txn]: /docs/v3.5/learning/api/#transaction
...
[etcd-watch]: /docs/v3.5/learning/api/#watch-streams

...
[conf-adv-client]: /docs/v3.6/op-guide/configuration/#clustering
[conf-listen-client]: /docs/v3.6/op-guide/configuration/#member
[discovery-proto]: /docs/v3.6/dev-internal/discovery_protocol/
[gateway]: /docs/v3.6/op-guide/gateway/
[proxy]: https://github.com/etcd-io/etcd/blob/release-2.3/Documentation/proxy.md
[rfc-srv]: http://www.ietf.org/rfc/rfc2052.txt
[runtime-conf]: /docs/v3.6/op-guide/runtime-configuration/
[runtime-reconf-design]: /docs/v3.6/op-guide/runtime-reconf-design/
[security-guide-dns-srv]: /docs/v3.6/op-guide/security/#notes-for-dns-srv
[security-guide]: /docs/v3.6/op-guide/security/

...
Тестування продуктивності etcd можна виконати за допомогою CLI інструменту [benchmark](https://github.com/etcd-io/etcd/tree/main/tools/benchmark), що входить до складу etcd.

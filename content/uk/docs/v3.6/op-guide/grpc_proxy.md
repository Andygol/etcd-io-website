...
Проксі-сервер підтримує реєстрацію своїх точок доступу для виявлення шляхом запису до точки доступу, визначеної користувачем. Це служить двом цілям. По-перше, це дозволяє клієнтам синхронізувати свої точки доступу з набором точок доступу проксі-сервера для високої доступності. По-друге, це постачальник точок доступу для etcd [gRPC naming](/docs/v3.6/dev-guide/grpc_naming/).

...
Дотримуйтесь цих інструкцій, щоб локально встановити, запустити і протестувати кластер, що складається з одного члена etcd:
 ...
 1. Встановіть etcd з попередньо зібраних двійкових файлів або з коду. Докладні відомості наведено у розділі [Встановлення][Install].
    ...
    **Важливо**: Переконайтеся, що ви виконали останній крок інструкцій з встановлення, щоб переконатися, що `etcd` є у вашій змінній PATH.
 ...
 2. Запустіть `etcd`:
    ...
    **Примітка**: Вивід, який створює `etcd` є [журналами](/docs/v3.6/op-guide/configuration/#logging)&nbsp;&mdash; логи інформаційного рівня можна ігнорувати.
...
- Якщо ви оператор або адміністратор:

...
Щоб оновити поточне розгортання etcd до 3.1, кластер, що працює, повинен бути версії 3.0 або вище. Якщо це версія до 3.0, будь ласка, [оновіть до 3.0](/docs/v3.6/upgrades/upgrade_3_0/) перед оновленням до 3.1.

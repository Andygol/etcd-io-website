...
Зверніть увагу, що сторонні бібліотеки та інструменти (не розміщені на [основному репозиторії etcd-io](https://github.com/etcd-io)), згадані нижче, не тестуються та не підтримуються командою etcd. Перед їх використанням рекомендується ознайомитися з ними та провести власне розслідування.

## Інструменти {#tools}

- [etcdctl](https://github.com/etcd-io/etcd/tree/main/etcdctl) - Клієнт командного рядка для etcd
...
- [etcd-tui](https://github.com/olamilekan000/etcd-tui) - Сучасний інтерфейс користувача терміналу (TUI) для взаємодії з вашою базою даних etcd. Навігація ключами, перегляд значень, фільтрація даних та управління кластером etcd безпосередньо з терміналу.
- [etcdfinder](https://etcdfinder.github.io) - Швидкий, сучасний вебінтерфейс для etcd з миттєвим пошуком. Підтримує як etcd v2, так і v3.
...
- [etcd-workbench](https://github.com/tzfun/etcd-workbench) - Безкоштовний та потужний UI-клієнт для etcd v3. Надає десктопний застосунок та вебпакети.
...
- [Користувачі etcd Raft](https://github.com/etcd-io/raft/blob/main/README.md#notable-users) - проєкти, що використовують реалізацію бібліотеки raft від etcd.
...
- [CoreDNS](https://github.com/coredns/coredns/tree/master/plugin/etcd) - CoreDNS - це DNS-сервер, що об'єднує втулки, частини CNCF та Kubernetes

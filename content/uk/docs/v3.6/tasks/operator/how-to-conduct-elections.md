...
description: Кроки для проведення виборів лідера за допомогою клієнта etcdctl
weight: 900
---

## Передумови {#prerequisites}

- Переконайтеся, що [`etcd`](/docs/v3.6/install/) та [`etcdctl`](/docs/v3.6/install/) встановлені.

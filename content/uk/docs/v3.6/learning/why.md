...
- У [Як робити розподілене блокування][fencing] Мартін Клеппманн ввів ідею *захисного токена*. Автори інтерпретують, що захисний токен — це номер ревізії у випадку etcd.
...
[etcd-commonname]: /docs/v3.6/op-guide/authentication/#using-tls-common-name
...
[etcd-json]: /docs/v3.6/dev-guide/api_grpc_gateway/
[etcd-linread]: /docs/v3.6/learning/api_guarantees/#linearizability
[etcd-mvcc]: /docs/v3.6/learning/data_model/
[etcd-rbac]: /docs/v3.6/op-guide/authentication/rbac/
[etcd-recipe]: https://godoc.org/github.com/etcd-io/etcd/client/v3/experimental/recipes
[etcd-reconfig]: /docs/v3.6/op-guide/runtime-configuration/
[etcd-txn]: /docs/v3.6/learning/api/#transaction
...
[etcd-watch]: /docs/v3.6/learning/api/#watch-streams

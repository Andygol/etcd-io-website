---
title: Тестування продуктивності використання памʼяті Watch
weight: 5250
...
Функції спостереження знаходяться в активній розробці, і їх використання памʼяті може змінюватися в процесі розвитку. Ми не очікуємо значного збільшення понад зазначені нижче цифри.
